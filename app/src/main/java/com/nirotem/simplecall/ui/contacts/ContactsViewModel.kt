...
class ContactsViewModel(private val phoneNumber: String) : ViewModel() {
    ...
    class ContactsViewModelFactory(private val phoneNumber: String) : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return ContactsViewModel(phoneNumber) as T
        }
    }
