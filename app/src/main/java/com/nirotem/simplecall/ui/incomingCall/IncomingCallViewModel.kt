...
class IncomingCallViewModel(private val phoneNumber: String) : ViewModel() {
    ...
    class IncomingCallViewModelFactory(private val phoneNumber: String) : ViewModelProvider.Factory {
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return IncomingCallViewModel(phoneNumber) as T
        }
    }
