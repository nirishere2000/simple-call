...
class UpgradeDialogFragment(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val title = view.findViewById<TextView>(R.id.upgradeTitle)
...
/*        title.text = if (isTrial) {
        ...
        val features = listOf(
            ...
            FeatureRow(view.context.getString(R.string.subscription_plan_feature_name_auto_answer), true, true),
...
/*        premiumFeaturesContainer?.addView(TextView(requireContext()).apply {
    ...
    private fun createFeatureTextView(title: String, isHeader: Boolean = false): TextView {
        return TextView(requireContext()).apply {
            text = if (isHeader) title else "• $title"
            setTextColor(Color.WHITE)
            ...
            layoutParams = LinearLayout.LayoutParams(
                ...
                topMargin = if (isHeader) 8.dpToPx() else 4.dpToPx()
